...
CREATE OR REPLACE PACKAGE perfumePack AS
	...
	PROCEDURE InsertIntoOrderList(ID perfume.pid%TYPE );
	PROCEDURE InsertIntoWishList(ID perfume.pid%TYPE );
	PROCEDURE RemoveFromOrderList(ID perfumeOrderList.pid%TYPE );
	PROCEDURE RemoveFromWishList(ID perfumeWishlist.pid%TYPE );
